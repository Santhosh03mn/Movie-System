...
<head>
    ...
    <style>
        /* Page Styling */
         body {
             background-image: url('https://t4.ftcdn.net/jpg/08/45/10/75/360_F_845107561_vNhctGj9V9wtYwUTXK4AxyjyGuRDFmXL.jpg');
...
<body>
<div aling="center">
<h1><u>List of ${Language} Movies</u></h1>
</div>
            ...
            <c:forEach var="movie" items="${movieList}">
                <tr>
                    ...
                    <td>
                       ...
                       <td> <a href="${pageContext.request.contextPath}/bookMovie/${movie.movieId}">Book Movie</a></td>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
